package com.billion_dollor_company.securutysystem.activities.main.user.ui.connected_devices
...
import com.billion_dollor_company.securutysystem.activities.main.user.ChatActivity
import com.billion_dollor_company.securutysystem.databinding.ActivityUserConnectedDevicesBinding
...
class UserConnectedDevicesActivity : AppCompatActivity(),ConnectedAdapter.OnNoteClickListener{

    private lateinit var binding:ActivityUserConnectedDevicesBinding
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding = ActivityUserConnectedDevicesBinding.inflate(layoutInflater)
    ...
    private fun setTheRecycler() {
        ...
        if (list.size != 0) {
            finalState()
            adapter = ConnectedAdapter(applicationContext, list, this,View.INVISIBLE)
